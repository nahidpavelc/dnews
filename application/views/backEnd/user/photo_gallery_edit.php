      ...
      <div class="box box-primary box-solid">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <a href="<?php echo base_url() ?>user/poll-options/list" type="submit" class="btn bg-purple btn-sm" style="color: white;"> <i class="fa fa-list"></i> <?php echo $this->lang->line('poll_options_list'); ?> </a>
          </div>
        </div>
        <div class="box-body">
          <div class="row">
            <form action="<?php echo base_url("user/poll-options/edit/" . $poll_opitons_info->id); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="col-md-12">
                <div class="col-md-4">
