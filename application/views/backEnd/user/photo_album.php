  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-purple box-solid">
        ...
        <div class="box-body">
          <?php if (isset($photo_album_info)) { ?>
            <!-- Photo Album Edit -->
            <div class="row">
              <div class="col-md-12">
                <form action="<?php echo base_url('user/photo-album/edit/' . $photo_album_id) ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <div class="col-sm-12">
                          ...
                          <input name="album_title" autocomplete="off" class="form-control inner_shadow_purple" placeholder="<?php echo $this->lang->line('album_title'); ?>" required="" type="text" value="<?php echo $photo_album_info->album_title; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <div class="col-sm-12">
                          ...
                          <input name="priority" placeholder="<?php echo $this->lang->line('priority'); ?>" value="<?php echo $photo_album_info->priority; ?>" class="form-control inner_shadow_purple" required="" type="number">
                        </div>
                      </div>
                    </div>
          ...
          <?php } else { ?>
            ...
            <div class="row">
              <div class="col-md-12" style="margin:18px ;">
                <form action="<?php echo base_url('user/photo-album/add/') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="col-md-1"></div>
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="<?= base_url('user/photo-album/edit/' . $value->id); ?>" class="btn btn-sm bg-teal"> <i class="fa fa-edit"></i> </a>
                          <a href="<?= base_url('user/photo-album/delete/' . $value->id); ?>" onclick="return confirm('Are you sure?')" class="btn btn-sm bg-red"> <i class="fa fa-trash"></i> </a>
                        </td>
                      </tr>
                    <?php
                    }
