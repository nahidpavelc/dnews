                        ...
                        <table  class="table table-bordered table-striped table_th_purple custom_table" style="width: 100%;">
                            ...
                            foreach ($photo_gallery_list as $key=>$value) {
                                ...
                                <tr >
                                    ...
                                    <td>
                                        <img class="img" src="<?php if(file_exists($value->photo_file)) echo base_url($value->photo_file);else echo base_url("assets/gallery.png") ?>" alt="Photo" width="50px" height="50px">
                                    </td>
                                    <td>
