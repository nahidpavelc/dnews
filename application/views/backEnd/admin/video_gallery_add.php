        ...
        <div class="col-md-12">
            ...
            <div class="box box-purple box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"> <?php echo $this->lang->line('video_gallery_add'); ?> </h3>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" id="youtube_video_link" name="youtube_video_link" required = '' placeholder="<?php echo $this->lang->line('youtube_video_link');?>" class="form-control inner_shadow_purple">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
