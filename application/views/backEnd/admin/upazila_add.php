        ...
        <div class="col-md-12">
            ...
            <div class="box box-purple box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"> <?php echo $this->lang->line('upazila_add'); ?> </h3>
                ...
                <div class="box-body">
                    <div class="row">
                        <form action="<?php echo base_url("admin/upazila/add");?>" method="post" enctype="multipart/form-data" class="form-horizontal">
