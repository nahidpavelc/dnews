                            ...
                            <div class="col-md-3">
                                ...
                                <div class="box box-purple box-solid">
                                    ...
                                    <div class="box-body box-profile">
                                        <center>
                                            <img id="user_picture_change" class="img-responsive" src="<?php if(file_exists($userDetails[0]['photo'])) echo base_url($userDetails[0]['photo']);else echo base_url('assets/upload.png') ?>" alt="profile picture" style="width: 100px; Height: 100px"><small style="color: gray">width : 400px, Height : 400px</small>
                                            <br>
