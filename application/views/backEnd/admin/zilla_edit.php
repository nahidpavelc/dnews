    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-purple box-solid">
                ...
                <div class="box-body">
                    <div class="row">
                        <form action="<?php echo base_url("admin/zilla/edit/" .$zilla_info->id);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <select name="divission_id" id="divission_id" class="form-control select2">
                                                ...
                                                <?php foreach ($division_list as $key =>$value) {?>
                                                    <option value="<?php echo $value->id;?>" <?php if($zilla_info->divission_id == $value->id) echo "selected"; ?> ><?php echo $value->name;?></option>
                                                <?php }?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" id="name" value="<?php echo $zilla_info->name;?>" name="name" required = '' placeholder="<?php echo $this->lang->line('name');?>" class="form-control inner_shadow_purple">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" id="name_en" value="<?php echo $zilla_info->name_en;?>" name="name_en" required = '' placeholder="<?php echo $this->lang->line('name_en');?>" class="form-control inner_shadow_purple">
                                        </div>
                                    </div>
                                </div>
                            </div>
