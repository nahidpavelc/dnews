                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="first_name" placeholder="<?php echo $this->lang->line('first_name'); ?>" class="form-control inner_shadow_purple" required="" type="text">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="last_name" placeholder="<?php echo $this->lang->line('last_name'); ?>" class="form-control inner_shadow_purple" required="" type="text">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="user_name" placeholder="<?php echo $this->lang->line('user_name'); ?>" class="form-control inner_shadow_purple" required="" type="text">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="email" placeholder="<?php echo $this->lang->line('email'); ?>" class="form-control inner_shadow_purple" required="" type="email">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="phone" placeholder="<?php echo $this->lang->line('phone'); ?>" class="form-control inner_shadow_purple" type="tel" pattern="[0]{1}[1]{1}[3|4|5|6|7|8|9]{1}[0-9]{8}">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="password" placeholder="<?php echo $this->lang->line('password'); ?>" class="form-control inner_shadow_purple" type="password">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="road_house" placeholder="<?php echo $this->lang->line('road_house'); ?>" class="form-control inner_shadow_purple" required="" type="text">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <br>
                      <select name="user_type" required="" class="form-control select2 inner_shadow_teal inner_shadow_teal">
              ...
              <div class="col-md-3">
                ...
                <div class="box box-purple box-solid">
                  ...
                  <div class="box-body box-profile">
                    <center>
                      <img id="user_picture_change" class="img-responsive" src="<?php echo base_url('assets/upload.png') ?>" alt="profile picture" style="width: 100px;Height:100px;"><small style="color: gray">width : 400px, Height : 400px</small>
                      <br>
