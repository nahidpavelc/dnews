            ...
            <div class="box box-purple box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo base_url("admin/zilla/add"); ?>" class="btn bg-orange btn-sm" style="color: white; "><i class="fa fa-plus"></i> <?php echo $this->lang->line('zilla_add') ?> </a>
                    </div>
                </div>
                <div class="box-body">
                    <div class="custom_table_box">
                        <table  class="table table-bordered table-striped table_th_purple custom_table" style="width: 100%;">
                            ...
                            foreach ($zilla_list as $key=>$value) {
                                ?>
                                <tr >
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('admin/zilla/edit/'.$value->id); ?>" class="btn btn-sm bg-teal"><i class="fa fa-edit"></i></a>
